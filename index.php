...
<head>
  ...
  <title>Poliklinik Keluarga Cemara</title>
...
<nav class="navbar navbar-expand-lg fixed-top navbar-scroll">
  <div class="container-fluid">
    <a class="text-light navbar-brand" href="#">Poliklinik Keluarga Cemara</a>
...
<div id="carouselExample" class="carousel slide">
  ...
  <div class="carousel-caption d-flex align-items-center justify-content-center">
    <div class="text-light text-center">
      <h1>Poliklinik Keluarga Cemara</h1>
      <p>SOLUSI SEHAT KELUARGA ANDA</p>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <ul class="list-unstyled">
          <li><a href="https://www.facebook.com"  id="sc-ic" class="fab fa-facebook text-light"></a> Poliklinik Keluarga Cemara</li>
          <li><a href="https://instagram.com" id="sc-ic" class="fab fa-instagram text-light"></a> klinik_cemara.smg</li>
      ...
      <div class="col-md-4">
        ...
        <ul class="list-unstyled">
          <li><a href="https://wa.me/+6282137023425" class="text-light">Akbar Ilham Ardin (ADMIN)</a></li>
        </ul>
      </div>
      <div class="col-md-4">
        <h5>Our Address</h5>
        <p class="text-light">JL. Wolter Monginsidi No.14</p>
      </div>
    </div>
  </div>
  <div class="container layar-dalam">
